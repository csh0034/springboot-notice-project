...
public class NoticeControllerTest extends TestControllerSupport {
	...
	public void test() throws Exception {
		...
		NoticeVO notice = json.toObject(mvcResult.getResponse().getContentAsString(), NoticeVO.class);
		...
		AttachmentVO[] attahcments = json.toObject(mvcResult.getResponse().getContentAsString(), AttachmentVO[].class);

		assertNotNull(attahcments);

		AttachmentVO attachment = attahcments[0];
